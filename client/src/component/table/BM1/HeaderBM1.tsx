    ...
    return (
        <thead className='w-full grid'>
            ...
            <tr className='grid grid-cols-12 w-full'>
                ...
                <td contentEditable={true} className='pb-1 text-[7px] border border-gray-800 col-span-3'></td>
            ...
            <tr className='grid grid-cols-12 w-full'>
                ...
                <td contentEditable={true} className='pb-1 text-[7px] border border-gray-800 col-span-5'>SAN JUAN DE LOS MORROS</td>
