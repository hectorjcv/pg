               ...
               items &&items.map(item => (
                <tr className='grid grid-cols-[repeat(20,5vw)] w-full'>
                    <td className='border col-span-4 grid grid-cols-3'>
                        <span className='h-full border-r text-sm' contentEditable={true}>{item.clasification_reference?.group_id}</span>
                        <span className='h-full border-r text-sm' contentEditable={true}>{item.clasification_reference?.sub_group_id}</span>
                        <span className='h-full text-sm' contentEditable={true}>{item.clasification_reference?.secction_id}</span>
                    </td>
